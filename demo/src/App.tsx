    ...
    <ConfigProvider locale={zhCN}>
      <div style={{ padding: 24, display: 'flex', flexDirection: 'column', gap: 32 }}>
        ...
        <section>
          ...
          <CollapseBox direction="horizontal" buttonPosition="right" defaultWidth="50%" defaultHeight={300}>
        ...
        <section>
          ...
          <CollapseBox direction="horizontal" buttonPosition="left" defaultWidth={500} defaultHeight={300}>
