...
export default function BorderBeamDemo() {
	...
	return (
		<div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
			{/* 11.1 基础用法 & 鼠标悬浮时显示 */}
			<div>
				<h3 style={{ fontSize: 16, marginBottom: 12 }}>11.1 基础用法 & 鼠标悬浮时显示</h3>
				<div
					style={{
						display: 'grid',
			...
			<div>
				...
				>
					...
					<div>
						...
						<p style={{ color: '#8c8c8c', fontSize: 13, marginTop: 8 }}>
							自定义容器。由于流光层可以通过 position: absolute 贴合容器边缘，宿主元素设置 position:
							relative 即可。
						</p>
					</div>
				</div>
			...
			{/* 11.3 动画时长 (duration) */}
			<div>
				<h3 style={{ fontSize: 16, marginBottom: 12 }}>11.3 动画时长 (duration)</h3>
				<div
					style={{
						display: 'grid',
			...
			{/* 11.4 尺寸 (size) */}
			<div>
				<h3 style={{ fontSize: 16, marginBottom: 12 }}>11.4 尺寸 (size)</h3>
				<div
					style={{
						display: 'grid',
						gridTemplateColumns: '1fr 1fr',
			...
			{/* 11.5 线宽 (lineWidth) */}
			<div>
				<h3 style={{ fontSize: 16, marginBottom: 12 }}>11.5 线宽 (lineWidth)</h3>
			...
			{/* 11.6 渐变色停靠点配置 */}
			<div>
				<h3 style={{ fontSize: 16, marginBottom: 12 }}>11.6 渐变色 (color) 预设切换</h3>
				<div
					style={{
						display: 'flex',
						gap: 8,
